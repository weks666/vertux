...
const T = {
  ...
  en: {
    ...
    'wg.lede':'The widget greets the client, answers questions and collects the lead any time - even at night and on weekends. One manager costs from 30,000₽ a month and gets tired. A widget runs non-stop and costs a fraction.',
    'wg.p1t':'Works 24/7','wg.p1d':'never sleeps, never sick, never on vacation','wg.p2t':'Saves on salary','wg.p2d':'7,000₽/mo instead of 30,000₽ for a manager','wg.p3t':'Never loses a client','wg.p3d':'catches the lead at the moment of interest',
    ...
    'pk.foot':'Site hosting and support on me - an option for +5,000₽/mo (via Cloudflare).',
    ...
    'faq.q4':'What is the difference between the 7,000 and 15,000 ₽ plans?','faq.a4':'At 7,000₽/mo the widget runs on your keys: you pay the AI tokens yourself and support is basic. At 15,000₽/mo everything is turnkey on me - tokens, hosting, updates and full support, nothing for you to think about. Cheaper, or hands-off - your call.',
    ...
    'faq.q6':'Who owns the site?','faq.a6':'In most cases - you: I hand over access, the domain and sources are registered to you. If you want me to host and maintain it (Cloudflare hosting, edits, monitoring) - that is an option for 5,000₽/mo.',
