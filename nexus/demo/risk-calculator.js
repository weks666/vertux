...
export function calculateRiskDraft(input = {}) {
  ...
  return {
    ...
    stopDistanceNanos: distance.toString(), direction, assetType, capitalLimited, lotSize:lot.toString(),
    riskPerUnitNanos: roundUp(perLot,lot).toString(), rewardPerUnitNanos: rewardPerLot===null?null:(rewardPerLot/lot).toString(),
