...
(() => {
 ...
 document.addEventListener('submit',e=>{if(e.target.matches('.terminal-date-form,.terminal-replay-date,[data-watch-list-form]'))return;e.preventDefault();e.stopImmediatePropagation();},true);
