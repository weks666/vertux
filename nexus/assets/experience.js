(() => {
  ...
  function paintPreview(root,period,animate=false) {
    ...
    if(animate&&!reduced.matches){const chart=$('.nx-preview-chart',root);chart.classList.remove('nx-chart-changing');requestAnimationFrame(()=>chart.classList.add('nx-chart-changing'));}
  }
